...
|---|---|---|---|---|
| **Tuned XGBoost** | **0.796** | 0.685 | 0.586 | 0.6350 |
| **Tuned Random Forest** | 0.803 | 0.719 | 0.572 | 0.631 |
| **Logistic Regression** | 0.760 | 0.698 | 0.486 | 0.565 |
| **Ensemble** | 0.793 | 0.719 | 0.577 | 0.647 |
